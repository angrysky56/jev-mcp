# Jev v2: development live run

Created: 2026-09-19T20:54:10.105Z. Provider: openrouter. Requested model: typesafe/jev-1.13.
Returned models: typesafe/jev-1.13-20260917.

Valid responses: 54/54. Failures: 0. Unattempted: 0. HTTP attempts: 54.
Validated-response input/output tokens: 41547/5826. Reported cost: $0.00174497. Cost coverage: 54/54 validated responses; failed requests may have unrecorded charges. Median successful request: 174 ms.
...
| b03 | reversed | unchanged | unchanged | 0.920 | match |
| b04 | canonical | unchanged | unchanged | 0.980 | match |
| b04 | paraphrase | unchanged | unchanged | 0.990 | match |
| b04 | reversed | unchanged | unchanged | 0.980 | match |
| b05 | canonical | insufficient | insufficient | 0.990 | match |
| b05 | paraphrase | insufficient | insufficient | 0.990 | match |
| b05 | reversed | insufficient | insufficient | 0.990 | match |
...
| q06 | paraphrase | insufficient | insufficient | 0.910 | match |
| q06 | reversed | insufficient | insufficient | 0.940 | match |
| a01 | canonical | responsive | responsive | 1.000 | match |
| a01 | paraphrase | responsive | responsive | 1.000 | match |
| a01 | reversed | responsive | responsive | 0.990 | match |
...
| a03 | canonical | responsive | responsive | 0.720 | match |
| a03 | paraphrase | responsive | responsive | 0.950 | match |
| a03 | reversed | responsive | responsive | 0.930 | match |
| a04 | canonical | insufficient | insufficient | 1.000 | match |
| a04 | paraphrase | insufficient | insufficient | 1.000 | match |
| a04 | reversed | insufficient | insufficient | 1.000 | match |
| a05 | canonical | self_sealing | self_sealing | 1.000 | match |
